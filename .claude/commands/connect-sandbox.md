---
description: Connect Maxwell to a sandbox for pinned scanners and runtime probe commands - asks where to run them (Kubernetes, Docker or Podman, E2B, Daytona, Modal, Vercel Sandbox, or this machine), stores the choice and any provider credentials outside the workspace, and verifies the connection with a pinned tool
