...
const PROBE_CHECKS = [
  ...
  'Cite the company\'s own sector instrument first (regulatory-catalogs skill): sebi-cscrf-2024 (PR.DS.S1 data-at-rest encryption, ID.AM.S5 data inventories, PR.AA.S13 retention and disposal) for SEBI REs, rbi-cyber-tech-directions-2026 or rbi-digital-payment-security-2021 for RBI REs and payment data, irdai-info-cyber-security-2023 for insurers. Add dpdp-rules-2025 and dpdp-act-2023 second for personal-data gaps; a DPDP rule whose commencement in instruments.json is after NOW is a secondary readiness mapping, never the first ref or the severity basis. Then pci-dss-4.0.1 (Req 3) where card data appears, owasp-asvs-5.0 (V2 validation and business logic, V14 data protection) and nist-800-53-r5 (SC-28, SI-10).',
];
